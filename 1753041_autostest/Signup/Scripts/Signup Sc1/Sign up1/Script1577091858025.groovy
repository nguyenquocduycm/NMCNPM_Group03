...
WebUI.setText(findTestObject('Page_Document/input_Email_email'), '')

'password 11111111'
WebUI.setEncryptedText(findTestObject('Page_Document/input_Password_password'), 'GYDmRgS5yd7gEHREC4bJaQ==')

WebUI.setText(findTestObject('Page_Document/input_First Name_fname'), '')

WebUI.setText(findTestObject('Page_Document/input_Last Name_lname'), '')
